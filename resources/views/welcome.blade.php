    ...
    <section class="section section-welcome">
        <div id="print-test">
            ...
            <x-ig::form>
                ...
                <x-ig::input type="text" name="name" label="Name" value="John" class="text-danger">Enter your name</x-ig::input>
                <x-ig::input type="email" name="email" label="Email" :clearable="false">Enter your email</x-ig::input>
